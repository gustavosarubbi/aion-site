...
interface TextTypeProps {
    ...
    /** If true, animation starts when element enters viewport, resets when it leaves */
...
const TextType = ({
    ...
    // Reset state so animation re-triggers from scratch
            ...
            (entries) => {
                entries.forEach((entry) => {
                    if (entry.isIntersecting) {
                        ...
                        // Element left viewport → reset so it plays again on re-entry
                        setIsVisible(false);
                        resetAnimation();
                    }
                });
