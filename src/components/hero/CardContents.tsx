...
export function CodeCardContent({ reducedDetail = false }: { reducedDetail?: boolean }) {
    ...
    return (
        <group position={[-1.2, 0.5, 0.15]}>
            ...
            {[
                ...
                <InteractiveDetail key={i} offsetMs={i * 34} reducedDetail={reducedDetail}>
                    {(pulse) => (
...
export function PreviewCardContent({ reducedDetail = false }: { reducedDetail?: boolean }) {
    return (
        <group position={[0, -0.1, 0.15]}>
            ...
            <InteractiveDetail offsetMs={18} reducedDetail={reducedDetail}>
                {(pulse) => (
            ...
            {[0.2, 1.0].map((x, i) => (
                <InteractiveDetail key={i} offsetMs={i * 40 + 60} reducedDetail={reducedDetail}>
                    {(pulse) => (
...
export function FlowCardContent({ baseColor, reducedDetail = false }: { baseColor: string; reducedDetail?: boolean }) {
    return (
        <group position={[0, -0.4, 0.15]}>
            ...
            {[
                ...
                <InteractiveDetail key={i} offsetMs={i * 36 + 24} reducedDetail={reducedDetail}>
                    {(pulse) => (
            ...
            <InteractiveDetail offsetMs={200} reducedDetail={reducedDetail}>
                {(pulse) => (
